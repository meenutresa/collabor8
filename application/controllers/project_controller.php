    ...
    function remove_leader($project_id){
        if($this->users->check_user_loggedin()){
            ...
            if($this->project->delete_leader($project_id)){
                $this->activity->add_activity($project_id,$this->session->userdata('username').' removed '.$this->input->post('user').' to be a leader of '.$project_data['title'],  $this->session->userdata('username'));
    ...
    function remove_developer($developer,$project_id){
        if($this->users->check_user_loggedin()){
            ...
            if($this->project->delete_developer($project_id,$developer)){
                $this->activity->add_activity($project_id,$this->session->userdata('username').' removed '.$this->input->post('user').' to be a developer of '.$project_data['title'],  $this->session->userdata('username'));
                $this->open_project($project_id);
            }
            else{
                $data['error_msg'] = 'sorry,you have no permission to access this page';
