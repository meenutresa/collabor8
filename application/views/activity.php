...
<div style="position:absolute;font-size:50px;font-family:Calibri;top:50px;left:50px">Recent Activities&nbsp;</div>
<div style="position:absolute; top:150px; left:100px; width:1000px">
  ...
  <?php
                //var_dump($a);
  echo '<img src="http://localhost/taskmanager/images/'.$a->profile_pic.'" width="40" height="40" id="dispic"/>';
  			echo $a->action." , ";
        	echo $a->performed_at;
